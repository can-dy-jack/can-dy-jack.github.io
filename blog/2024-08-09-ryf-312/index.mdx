...
- （2）[深圳宣布](https://www.163.com/dy/article/J8JF06LI0512D03F.html)，2025年底全市建成1000个以上低空飞行器起降平台。
- （3）[uBlock Origin](https://www.landiannews.com/archives/105251.html) 很快将无法在 Chrome 上使用，需要安装 uBlock Origin Lite。
- （4）[Chrome 浏览器加入货币化](https://www.bleepingcomputer.com/news/google/google-chrome-will-let-you-send-money-to-your-favourite-website/)（monetization）接口，帮助网站所有者接受付款。

## 文章
### [指定 PDF 的跳转页面（英文）](https://technicalwriting.dev/www/pdf.html)

![](./img21.webp)

很多人不知道，在 URL 链接里面可以指定，浏览器跳转到 PDF 文件的第几页。

### [从测试驱动学习 Go 语言（英文）](https://kovalevsky.io/full-introduction-to-golang-with-test-driven-development-part-1/)

![](./img22.webp)

一篇初学者教程，从写测试用例开始，教你学习 Go 语言。

### [软考高级架构师备考记录（中文）](https://nekonull.me/posts/ruankao-architect/)

![](./img23.webp)

作者参加24年上半年高级资格"系统架构设计师"的考试并成功通过。（[@jerrylususu](https://github.com/ruanyf/weekly/issues/4932) 投稿）

### [向量搜索是什么？（英文）](https://blog.shalvah.me/posts/an-exploration-of-vector-search)

![](./img24.webp)

本文用简单的例子，讲解如何将文本转换成向量（vector）进行搜索。

### [PostgREST 教程（英文）](https://notso.boringsql.com/posts/postgrest-tutorial-part1/)

![](./img25.webp)

PostgREST 这个工具可以为 PostgreSQL 数据库加上 REST 接口，用户就可以直接通过 HTTP 请求操作数据库。
本文是一篇详细教程。

### [一步步生成一张 TLS 证书（英文）](https://0x00.cl/blog/2024/exploring-tls-certs/)

![](./img26.webp)

在这篇长文中，作者演示如何手动生成一张网站的 TLS 证书，详细讲解了每个字段的含义。

### [我的异端思想（英文）](https://www.edge.org/conversation/freeman_dyson-heretical-thoughts-about-science-and-society)

![](./img27.webp)

物理学家弗里曼·戴森（Freeman Dyson）的一篇长文，解释他为什么不担心全球变暖。
这篇文章读起来有些费劲，但是很有启发，虽然结论未必正确。
...
## 资源
### [OpenBSD 新手安装指南（英文）](https://btxx.org/posts/OpenBSD_is_a_Cozy_Operating_System/)
...
## 言论
1、 AI 的危险在于，它让你跳过思考，让机器填补思想的空白。我们需要 AI 使我们增加思考，而不是减少思考。
